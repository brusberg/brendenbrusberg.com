(() => {
  ...
  registry.ants = () => ({
    ...
    summary:
      'I work on designing platforms to better understand and evaluate complex systems in organizations, leveraging multidisciplinary skills and teams to nurture real value.',
    storyHtml: [
