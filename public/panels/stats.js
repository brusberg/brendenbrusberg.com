(() => {
  ...
  registry.stats = () => ({
    ...
    title: 'Stats',
    summary:
      'This is a simulation inspired by OpenTTD, a fun game about trains.',
    storyHtml: `
      <div class="stat-list">
