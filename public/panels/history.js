(() => {
  ...
  registry.mandelbrot = () => ({
    ...
    title: 'History',
    summary:
      'Mandelbrot and Julia. The Mandelbrot and Julia panel is a recreation of an old Mandelbrot and Julia calculator app, the first full programming project I made on my own in high school.',
    summaryHtml:
      '<a href="https://en.wikipedia.org/wiki/Mandelbrot_set">Mandelbrot</a> and <a href="https://en.wikipedia.org/wiki/Julia_set">Julia</a>. The Mandelbrot and Julia panel is a recreation of an old Mandelbrot and Julia calculator app, the first full programming project I made on my own in high school. The <a href="https://en.wikipedia.org/wiki/Mandelbrot_set">Mandelbrot set</a> treats each pixel as a complex number <span class="math-step">c</span>. Starting with <span class="math-step">z = 0</span>, the computer repeats <span class="math-step">z = z<sup>2</sup> + c</span>. Points that never escape draw the dark body; points that escape become color and texture. Case one: if repeated values stay bounded, the point belongs to the set. Case two: if the values race away, the point escapes and gets colored by how quickly it left. A <a href="https://en.wikipedia.org/wiki/Julia_set">Julia set</a> uses the same equation, but keeps <span class="math-step">c</span> fixed. Tap the Mandelbrot map to choose <span class="math-step">c</span>, and the second world shows the shape created by that one parameter.',
    storyHtml: [
      ...
      'Lately I have been focused on how my time is spent nurturing rather than extracting, in the spirit of Wendell Berry. I’ve now been working with <a href="https://www.linkedin.com/in/andrejmarsic/">Andrej</a> and <a href="https://www.linkedin.com/in/petra-kummerova-07612659/">Petra</a>, who showed me how to have fun at work and inspire me every day. A lot of my most fulfilling work has been TAing, volunteering as a tutor, and teaching at work. <a href="#art">I think there is so much more we all have to offer the world, and I would love to offer my time to work with anyone who agrees.</a>',
    ],
